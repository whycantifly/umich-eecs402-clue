...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Fri Apr 6 03:01:06 2012
...
SOURCES       = AccusationDialogClass.cpp \
		...
		getDoorsForRoom.cpp moc_AccusationDialogClass.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/umich-eecs402-clue1.0.0/ && $(COPY_FILE) --parents AccusationDialogClass.h BoardLocationClass.h cardToRoom.h cardToSuspect.h cardToWeapon.h ClueMainWindowClass.h constants.h DeckClass.h enums.h ExceptionClass.h HandleSuggestionDialogClass.h PlayerClass.h roomToCard.h SuggestionClass.h SuggestionDialogClass.h suspectToCard.h weaponToCard.h getStartingDoorIndex.h getDoorsForRoom.h .tmp/umich-eecs402-clue1.0.0/ && $(COPY_FILE) --parents AccusationDialogClass.cpp BoardLocationClass.cpp ClueMainWindowClass.cpp DeckClass.cpp ExceptionClass.cpp HandleSuggestionDialogClass.cpp main.cpp PlayerClass.cpp SuggestionClass.cpp SuggestionDialogClass.cpp getStartingDoorIndex.cpp getDoorsForRoom.cpp .tmp/umich-eecs402-clue1.0.0/ && $(COPY_FILE) --parents AccusationDialogClass.ui ClueMainWindowClass.ui HandleSuggestionDialogClass.ui SuggestionDialogClass.ui .tmp/umich-eecs402-clue1.0.0/ && (cd `dirname .tmp/umich-eecs402-clue1.0.0` && $(TAR) umich-eecs402-clue1.0.0.tar umich-eecs402-clue1.0.0 && $(COMPRESS) umich-eecs402-clue1.0.0.tar) && $(MOVE) `dirname .tmp/umich-eecs402-clue1.0.0`/umich-eecs402-clue1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/umich-eecs402-clue1.0.0
...
getStartingDoorIndex.o: getStartingDoorIndex.cpp getStartingDoorIndex.h \
		enums.h \
		constants.h \
		SuggestionClass.h \
		BoardLocationClass.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o getStartingDoorIndex.o getStartingDoorIndex.cpp

getDoorsForRoom.o: getDoorsForRoom.cpp getDoorsForRoom.h \
		enums.h \
		getStartingDoorIndex.h \
		constants.h \
		SuggestionClass.h \
		BoardLocationClass.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o getDoorsForRoom.o getDoorsForRoom.cpp
