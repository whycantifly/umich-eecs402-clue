...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Tue Apr 3 02:38:53 2012
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I/usr/include/qt4/QtTest -I. -I. -I.
LINK          = g++
LFLAGS        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/umich-eecs402-clue1.0.0/ && $(COPY_FILE) --parents AccusationDialogClass.h BoardLocationClass.h cardToRoom.h cardToSuspect.h cardToWeapon.h CaseFileClass.h ClickableLabelClass.h ClueMainWindowClass.h constants.h DeckClass.h enums.h ExceptionClass.h PlayerClass.h roomToCard.h SuggestionClass.h SuggestionDialogClass.h suspectToCard.h weaponToCard.h .tmp/umich-eecs402-clue1.0.0/ && $(COPY_FILE) --parents AccusationDialogClass.cpp BoardLocationClass.cpp CaseFileClass.cpp ClickableLabelClass.cpp ClueMainWindowClass.cpp DeckClass.cpp ExceptionClass.cpp main.cpp PlayerClass.cpp SuggestionClass.cpp SuggestionDialogClass.cpp .tmp/umich-eecs402-clue1.0.0/ && $(COPY_FILE) --parents AccusationDialogClass.ui ClueMainWindowClass.ui SuggestionDialogClass.ui .tmp/umich-eecs402-clue1.0.0/ && (cd `dirname .tmp/umich-eecs402-clue1.0.0` && $(TAR) umich-eecs402-clue1.0.0.tar umich-eecs402-clue1.0.0 && $(COMPRESS) umich-eecs402-clue1.0.0.tar) && $(MOVE) `dirname .tmp/umich-eecs402-clue1.0.0`/umich-eecs402-clue1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/umich-eecs402-clue1.0.0
...
compiler_moc_header_make_all: moc_AccusationDialogClass.cpp moc_ClickableLabelClass.cpp moc_ClueMainWindowClass.cpp moc_SuggestionDialogClass.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_AccusationDialogClass.cpp moc_ClickableLabelClass.cpp moc_ClueMainWindowClass.cpp moc_SuggestionDialogClass.cpp
...
moc_ClickableLabelClass.cpp: ClickableLabelClass.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) ClickableLabelClass.h -o moc_ClickableLabelClass.cpp
...
ClickableLabelClass.o: ClickableLabelClass.cpp ClickableLabelClass.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ClickableLabelClass.o ClickableLabelClass.cpp
...
moc_ClickableLabelClass.o: moc_ClickableLabelClass.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ClickableLabelClass.o moc_ClickableLabelClass.cpp
